...
const ActuatorsRefStruct = StructType({
...
const ActuatorsRefArray = ArrayType(ActuatorsRefStruct);
const ActuatorsRefStructArray = StructType({
  data: ActuatorsRefArray,
...
class ActuatorsWrapper {
  constructor(other) {
    ...
    if (typeof other === 'object' && other._refObject) {
      this._refObject = new ActuatorsRefStruct(other._refObject.toObject());
  ...
  _initMembers() {
    this._refObject = new ActuatorsRefStruct();
  ...
  static createFromRefObject(refObject) {
    let self = new ActuatorsWrapper();
    self.copyRefObject(refObject);
    return self;
  }
  static createArray() {
    return new ActuatorsArrayWrapper;
  }
  static get ArrayType() {
    return ActuatorsArrayWrapper;
  }
  static get refObjectArrayType() {
    return ActuatorsRefStructArray
  }
  static get refObjectType() {
    return ActuatorsRefStruct;
  }
  toRawROS() {
    this.freeze(true);
  ...
  static destoryRawROS(msg) {
    ActuatorsWrapper.freeStruct(msg.refObject);
  }
  static type() {
    return {pkgName: 'actuator_msgs', subFolder: 'msg', interfaceName: 'Actuators'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  copyRefObject(refObject) {
    this._refObject = new ActuatorsRefStruct(refObject.toObject());
...
class ActuatorsArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof ActuatorsWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new ActuatorsWrapper(value);
      }
    });
  }
  ...
  set size(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to ActuatorsArrayWrapper.size setter');
      return;
    }
  ...
  set capacity(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to ActuatorsArrayWrapper.capacity setter');
    }
    return this._resize(value);
  }
  get refObject() {
  ...
  _resize(size) {
    ...
    this._refArray = new ActuatorsRefArray(size);
    this._refObject = new ActuatorsRefStructArray();
    this._refObject.size = size;
    this._refObject.capacity = size;
    this._wrappers = new Array();
    for (let i = 0; i < size; i++) {
      this._wrappers.push(new ActuatorsWrapper());
    }
  }
  ...
  copy(other) {
    if (! (other instanceof ActuatorsArrayWrapper)) {
      throw new TypeError('Invalid argument: should provide "ActuatorsArrayWrapper".');
    }
  ...
  static freeArray(refObject) {
    ...
    for (let index = 0; index < refObject.size; index++) {
      ActuatorsWrapper.freeStruct(refObjectArray[index]);
    }
  }
...
module.exports = ActuatorsWrapper;
/*
